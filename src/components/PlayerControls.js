...
/* ─── Inline SVG Icons ─── */
const IconPrev = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M6 6h2v12H6V6zm3.5 6 8.5 6V6l-8.5 6z" }) }));
const IconPlay = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M8 5v14l11-7L8 5z" }) }));
const IconPause = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M6 19h4V5H6v14zm8-14v14h4V5h-4z" }) }));
const IconNext = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M6 18l8.5-6L6 6v12zm10-12v12h2V6h-2z" }) }));
const IconShuffle = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M10.59 9.17 5.41 4 4 5.41l5.17 5.17 1.42-1.41zM14.5 4l2.04 2.04L4 18.59 5.41 20 17.96 7.46 20 9.5V4h-5.5zm.33 9.41-1.41 1.41 3.13 3.13L14.5 20H20v-5.5l-2.04 2.04-3.13-3.13z" }) }));
const IconSequential = () => (_jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M14 16v-4l8 5-8 5v-4H2v-2h12zM10 8V4L2 9l8 5v-4h12V8H10z", opacity: "0.5" }) }));
...
const PlayerControls = () => {
    ...
    return (_jsxs("div", { className: "w-full flex items-center justify-between gap-6 px-2", children: [_jsx("div", { className: "flex-1 hidden md:block" }), _jsxs("div", { className: "flex flex-col items-center gap-3 flex-[2] min-w-0", children: [currentTrack ? (_jsxs("div", { className: "flex flex-col items-center min-w-0 w-full animate-in fade-in slide-in-from-bottom-2 duration-500", children: [_jsxs("div", { className: "text-sm font-bold text-[var(--color-text-primary)] truncate max-w-full tracking-tight", title: `${currentTrack.artist || 'Unknown Artist'} - ${currentTrack.title || currentTrack.path.split(/[\\/]/).pop()}`, children: [_jsx("span", { className: "text-[var(--color-primary)]", children: currentTrack.artist || 'Unknown Artist' }), _jsx("span", { className: "text-[var(--color-text-muted)] mx-2 opacity-50", children: "\u2022" }), _jsx("span", { children: currentTrack.title || currentTrack.path.split(/[\\/]/).pop() })] }), _jsxs("div", { className: "flex items-center justify-center gap-2 mt-1 flex-wrap", children: [currentTrack.bitrate && (_jsxs("span", { className: "text-[0.6rem] px-2 py-0.5 rounded-full bg-black/5 dark:bg-white/10 text-[var(--color-text-secondary)] border border-[var(--glass-border)] whitespace-nowrap font-bold tracking-wider uppercase", children: [Math.round(currentTrack.bitrate / 1000), " kbps"] })), currentTrack.format && (_jsx("span", { className: "text-[0.6rem] px-2 py-0.5 rounded-full bg-black/5 dark:bg-white/10 text-[var(--color-text-secondary)] border border-[var(--glass-border)] uppercase whitespace-nowrap font-bold tracking-wider", children: currentTrack.format })), currentTrack.genre && (_jsx("span", { className: "text-[0.6rem] px-2 py-0.5 rounded-full bg-black/5 dark:bg-white/10 text-[var(--color-text-secondary)] border border-[var(--glass-border)] whitespace-nowrap truncate max-w-[100px] font-bold tracking-wider uppercase", children: currentTrack.genre }))] })] })) : (_jsx("div", { className: "h-10" }) /* Placeholder to keep layout stable */), _jsxs("div", { className: "player-controls", children: [_jsx("button", { onClick: toggleShuffle, "aria-label": "Toggle shuffle", className: "player-control-btn", style: { opacity: shuffle ? 1 : 0.4 }, children: shuffle ? _jsx(IconShuffle, {}) : _jsx(IconSequential, {}) }), _jsx("button", { onClick: prevTrackAction, "aria-label": "Previous track", className: "player-control-btn", children: _jsx(IconPrev, {}) }), _jsx("button", { onClick: togglePlay, "aria-label": isPlaying ? "Pause" : "Play", className: "player-control-btn play-btn-main", children: isPlaying ? _jsx(IconPause, {}) : _jsx(IconPlay, {}) }), _jsx("button", { onClick: nextTrackAction, "aria-label": "Next track", className: "player-control-btn", children: _jsx(IconNext, {}) }), _jsx("div", { className: "repeat-toggle", children: _jsx("button", { onClick: cycleRepeatAction, "aria-label": "Cycle repeat mode", className: "player-control-btn", style: { opacity: repeat === 'none' ? 0.4 : 1 }, children: repeat === 'one' ? _jsx(IconRepeatOne, {}) : _jsx(IconRepeatAll, {}) }) }), _jsx("div", { className: "infinity-toggle", style: { marginLeft: '12px' }, children: _jsx("button", { onClick: toggleInfinityMode, "aria-label": "Toggle Infinity Mode", className: "player-control-btn", style: {
