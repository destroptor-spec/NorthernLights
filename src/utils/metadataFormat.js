 ...
 */
export async function parseFlacMetadata(arrayBuffer) {
 ...
 */
export async function parseMp3Metadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
 ...
 */
export async function parseWmaMetadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
 ...
 */
export async function parseOggMetadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
 ...
 */
export async function parseWavMetadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
 ...
 */
export async function parseM4aMetadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
 ...
 */
export async function parseAacMetadata(arrayBuffer) {
    const tokenizer = fromBuffer(new Uint8Array(arrayBuffer), { fileInfo: { size: arrayBuffer.byteLength } });
    return await mm.parseFromTokenizer(tokenizer, { duration: true });
}
/**
